...
task runManta {
    ...
    output {
        File diploidFile = "results/variants/~{tumor_sample}_Manta.diploidSV.vcf.gz"
        File somaticFile = "results/variants/~{tumor_sample}_Manta.somaticSV.vcf.gz"
        File candidateFile = "results/variants/~{tumor_sample}_Manta.candidateSV.vcf.gz"
        File candidateSmallIndelsFile = "results/variants/~{tumor_sample}_Manta.candidateSmallIndels.vcf.gz"
    }
